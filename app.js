...
App.prototype.generateGcode = function(){
  ...
  this.layer = new Layer(1,0.2, 0.2, 600);  //layer, layerheight, thickness, speed  // armband 0.1 thickness
  ...
  this.layer = new Layer(2,0.1, 0.2, 400);  //layer, layerheight, thickness, speed  // armband 0.1 thickness
  this.structure = new Structure(this.pattern, this.first, 0.2);  // 0.5
