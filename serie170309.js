...
App.prototype.generateGcode = function(){
  ...
  this.layer = new Layer(1,0.5,0.1,800); //layer, layerheight, thickness, speed
  ...
  this.layer = new Layer(1,0.5, 0.1, 800);  //layer, layerheight, thickness, speed  // armband 0.1 thickness
  ...
  this.layer = new Layer(3, 0.5, 0.1, 100);  //layer, layerheight, thickness, speed  // armband 0.1 thickness
  ...
  this.layer = new Layer(19,0.5, 0.1, 800);  //layer, layerheight, thickness, speed  // armband 0.1 thickness
  this.pattern = new Pattern("Round", "Flat",1,200);  //type, name, rows, stitches
  this.structure = new Structure(this.pattern, this.first, this.layer.layerheight);  // 0.5
  this.gcode.getCode(this.layer.gcode());
  this.gcode.getCode(this.structure.gcode(this.settings, this.layer));
